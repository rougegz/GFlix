...
open class FilemoonExtractor : Extractor() {
    ...
    override suspend fun extract(link: String): Video {
        ...
        Log.i("GFlixES", "[Filemoon] Extraction started for: $link")

        // 1. Details
        val detailsUrl = "$currentDomain/api/videos/$videoId/embed/details"
        Log.i("GFlixES", "[Filemoon] Details Request: $detailsUrl")
        ...
        Log.i("GFlixES", "[Filemoon] Playback Domain detected: $playbackDomain")

        // 2. Challenge
        val challengeUrl = "$playbackDomain/api/videos/access/challenge"
        Log.i("GFlixES", "[Filemoon] Challenge Request: $challengeUrl")
        ...
        Log.i("GFlixES", "[Filemoon] Challenge Data: ID=$challengeId, Viewer=$viewerId")

        // 3. Attestation
        val attestation = generateAttestation(nonce)
        val attestUrl = "$playbackDomain/api/videos/access/attest"
        Log.i("GFlixES", "[Filemoon] Attest Request: $attestUrl")
        ...
        Log.i("GFlixES", "[Filemoon] Attest Token obtained (Confidence: $confidence)")

        // 4. Playback
        val playbackUrl = "$playbackDomain/api/videos/$videoId/embed/playback"
        Log.i("GFlixES", "[Filemoon] Playback Request: $playbackUrl")
        ...
        Log.i("GFlixES", "[Filemoon] Decrypting data...")
        ...
        Log.i("GFlixES", "[Filemoon] SOURCE FOUND: $sourceUrl")
