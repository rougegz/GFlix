...
import com.gflix.app.utils.CustomTabHelper
...
class PlayerViewModel(
    ...
    private fun getServers(videoType: Video.Type, id: String) = viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            Log.i("GFlixES", "[SERVERS LIST] -> Provider: ${UserPreferences.currentProvider!!.name}")
            Log.i("GFlixES", "[SERVERS LIST] -> Found ${servers.size} servers: ${servers.joinToString { it.name }}")
