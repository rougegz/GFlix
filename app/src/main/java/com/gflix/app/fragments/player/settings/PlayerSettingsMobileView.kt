...
import com.gflix.app.databinding.ItemSettingMobileBinding
import com.gflix.app.databinding.ViewPlayerSettingsMobileBinding
import com.gflix.app.utils.dp
import com.gflix.app.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.gflix.app.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.gflix.app.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.gflix.app.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.gflix.app.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
