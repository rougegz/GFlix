package com.gflix.app.fragments.player.settings
...
import com.gflix.app.utils.findClosest
import com.gflix.app.utils.getAlpha
import com.gflix.app.utils.getRgb
import com.gflix.app.utils.mediaServerId
import com.gflix.app.utils.mediaServers
import com.gflix.app.utils.setAlpha
import com.gflix.app.utils.setRgb
import com.gflix.app.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.gflix.app.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.gflix.app.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.gflix.app.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.gflix.app.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
