...
object MEGAKinoProvider : Provider {
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        return Genre(id, genreName, items.filterIsInstance<com.gflix.app.models.Show>())
    }
    ...
    override suspend fun getPeople(id: String, page: Int): People {
        ...
        val filmography = parseContentItems(document).filterIsInstance<com.gflix.app.models.Show>()
