...
import com.gflix.app.extractors.VixcloudExtractor
...
import com.gflix.app.utils.InertiaUtils
import com.gflix.app.utils.NetworkClient
import com.gflix.app.utils.TmdbUtils
...
class StreamingCommunityProvider(private val _language: String? = null) : Provider {
    ...
    override suspend fun getServers(id: String, videoType: Video.Type): List<Video.Server> {
        Log.i("GFlixES", "[PROV] -> StreamingCommunity: getServers for $id")
        ...
        Log.i("GFlixES", "[PROV] -> Found Vixcloud src: $src")
        return listOf(Video.Server(id = id, name = "Vixcloud", src = src))
    }

    override suspend fun getVideo(server: Video.Server): Video {
        Log.i("GFlixES", "[SERVER] -> StreamingCommunity: Using ${server.name} (Src: ${server.src})")
