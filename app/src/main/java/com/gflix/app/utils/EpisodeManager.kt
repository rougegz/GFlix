...
import com.gflix.app.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.gflix.app.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {
